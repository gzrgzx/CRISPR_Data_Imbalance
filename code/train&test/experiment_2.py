...
test_dataset = ['Kleinstiver_5gRNA', 'k562', 'hek293t']
...
if flag == 12:
    for dataset in list_dataset:
        for t_dataset in test_dataset:
            ...
            x, y, inputshape = newnetwork.pre_transformIO(loaddata1.images, loaddata1.target, seg_len,
            ...
            CrisprDNT_model = load_model('{}+CrisprDNT.h5'.format(open_name),
            ...
            custom_objects.update(my_objects)
            CrisprDNT_focal_loss = load_model('{}+CrisprDNT_focal_loss.h5'.format(open_name),
                               custom_objects=custom_objects)
            ...
            custom_objects.update(my_objects)
            CrisprDNT_GHM = load_model('{}+CrisprDNT_GHM.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            my_objects = {'PositionalEncoding': PositionalEncoding}
            custom_objects.update(my_objects)
            CrisprDNT_oversampling = load_model('{}+CrisprDNT_oversampling.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_SMOTE = load_model('{}+CrisprDNT_SMOTE.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_ADASYN = load_model('{}+CrisprDNT_ADASYN.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_BorderlineSMOTE = load_model('{}+CrisprDNT_BorderlineSMOTE.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_SVMSMOTE = load_model('{}+CrisprDNT_SVMSMOTE.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_undersampling = load_model('{}+CrisprDNT_undersampling.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_NearMiss = load_model('{}+CrisprDNT_NearMiss.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_ENN = load_model('{}+CrisprDNT_ENN.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_NearMiss_3 = load_model('{}+CrisprDNT_NearMiss_3.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_TomekLinks = load_model('{}+CrisprDNT_TomekLinks.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_SMOTETomek = load_model('{}+CrisprDNT_SMOTETomek.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            CrisprDNT_SMOTEENN = load_model('{}+CrisprDNT_SMOTEENN.h5'.format(open_name),
                                               custom_objects=custom_objects)
            ...
            data_save = {'test': ytest, 'CrisprDNT': prob1, 'CrisprDNT_focal_loss': prob2, 'CrisprDNT_GHM': prob3,
                         'CrisprDNT_oversampling': prob4, 'CrisprDNT_SMOTE': prob5, 'CrisprDNT_ADASYN': prob6,
                         'CrisprDNT_BorderlineSMOTE': prob7,
                         'CrisprDNT_SVMSMOTE': prob9, 'CrisprDNT_undersampling': prob10,
                         'CrisprDNT_NearMiss': prob11, 'CrisprDNT_ENN': prob12,
                         'CrisprDNT_NearMiss_3': prob14, 'CrisprDNT_TomekLinks': prob15,
                         'CrisprDNT_SMOTETomek': prob16, 'CrisprDNT_SMOTEENN': prob17}

            data_save = pd.DataFrame(data_save)

            data_save.to_csv(dataset + '_' + t_dataset + '_CrisprDNT_prob.csv', index=None)
